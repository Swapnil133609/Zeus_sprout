...
#define BATCH_FUN(f)                pr_notice(BATCH_TAG"%s\n", __func__)
#define BATCH_ERR(fmt, args...)     pr_err(BATCH_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define BATCH_LOG(fmt, args...)     pr_notice(BATCH_TAG fmt, ##args)
#define BATCH_VER(fmt, args...)     pr_notice(BATCH_TAG"%s: "fmt, __func__, ##args)
#define BATCH_WARN(fmt, args...)    pr_warn(BATCH_TAG"%s: "fmt, __func__, ##args)
