...
#define MSM_MPDEC_IDLE_FREQ		598000
...
static int mp_decision(void) {
	...
	if ((nr_cpu_online < DEFAULT_MAX_CPUS_ONLINE)) {
...
static int __refdata bricked_hotplug_probe(struct platform_device *pdev)
{
	int ret = 0;
