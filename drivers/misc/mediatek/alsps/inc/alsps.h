...
#define ALSPS_FUN(f)                 pr_notice(ALSPS_TAG"%s\n", __func__)
#define ALSPS_ERR(fmt, args...)      pr_err(ALSPS_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define ALSPS_LOG(fmt, args...)      pr_notice(ALSPS_TAG fmt, ##args)
#define ALSPS_WARN(fmt, args...)      pr_warn(ALSPS_TAG"%s: "fmt, __func__, ##args)
