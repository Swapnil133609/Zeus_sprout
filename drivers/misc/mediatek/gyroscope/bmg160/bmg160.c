...
#else
static void bmg_power_suspend(struct power_suspend *h)
{
    struct bmg_i2c_data *obj =
        container_of(h, struct bmg_i2c_data, power_drv);
    int err =0;
    GYRO_FUN();
...
static void bmg_power_resume(struct power_suspend *h)
{
    struct bmg_i2c_data *obj =
        container_of(h, struct bmg_i2c_data, power_drv);
    int err=0;
        ...
        const struct i2c_device_id *id)
{
    ...
    obj->power_drv.suspend  = bmg_power_suspend,
    obj->power_drv.resume   = bmg_power_resume,
