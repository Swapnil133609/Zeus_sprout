	...
	if ((single_touch) && (s2w_scr_suspended == true) && (s2w_switch > 0 && ((s2w_switch == 3) ? 1 : !s2w_s2sonly))) {
		...
		if (is_ltr) {
			...
			if ((barrier[0] == true) ||
				((x > prevx) &&
				(x < nextx) &&
				(y > (((s2w_switch == 2) || ((s2w_switch == 3) ? dt2w_sent_play_pause : 0)) ? 0 : S2W_Y_LIMIT)))) {
				prevx = nextx;
				nextx = S2W_X_B2;
				barrier[0] = true;
				if ((barrier[1] == true) ||
					...
					if ((x > prevx) &&
						...
						if (x > (S2W_X_MAX - S2W_X_FINAL)) {
							if (exec_count) {
								if ((s2w_switch == 3) && (dt2w_sent_play_pause) && (y < S2W_Y_LIMIT)) {
									if (y <= S2W_X_B1) {
				...
				if ((barrier[1] == true) ||
					...
					if ((x < prevx) &&
						...
						if (x < S2W_X_B1) {
							if (exec_count) {
								if ((s2w_switch == 3) && (dt2w_sent_play_pause) && (y < S2W_Y_LIMIT)) {
									pr_info(LOGTAG"LTR: MusiqMod: y = %i, S2W_X_B2 = %i!\n", y, S2W_X_B2);
									if (y <= S2W_X_B1) {
