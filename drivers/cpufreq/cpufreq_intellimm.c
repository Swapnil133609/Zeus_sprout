...
#define DEF_POWER_SAVE_FREQUENCY		( 747500)
#define DEF_TWO_PHASE_FREQUENCY			( 598000)
#define DBS_INPUT_EVENT_MIN_FREQ		(1040000)
#define DEF_FREQUENCY_OPTIMAL			(1196000)
#define DEF_FREQ_DOWN_STEP			(1300000)
#define DEF_FREQ_DOWN_STEP_BARRIER		(1196000)
#endif
